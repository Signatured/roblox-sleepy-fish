...
local MutationTypes = require(game.ReplicatedStorage.Game.Library.Types.Mutations)
export type dir_schema = MutationTypes.dir_schema

local Children: typeof(workspace.__DIRECTORY.Mutations) = require(game.ReplicatedStorage.DirectoryLoader):WaitForChild(script.Name)

local module: {[string]: MutationTypes.dir_schema} = {}
